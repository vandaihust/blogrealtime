...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> handleBlogAPIException(BlogAPIException exeption, WebRequest webRequest) {
		ErrorDetails errorDetails = new ErrorDetails(new Date(), exeption.getMessage(),
				webRequest.getDescription(false));
...
//	global exception
	...
	public ResponseEntity<ErrorDetails> handleGlobalException(Exception exeption, WebRequest webRequest) {
		ErrorDetails errorDetails = new ErrorDetails(new Date(), exeption.getMessage(),
				webRequest.getDescription(false));
